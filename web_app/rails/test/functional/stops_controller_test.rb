...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { line_id: @stop.line_id, times: @stop.times, title: @stop.title, x: @stop.x, y: @stop.y }
    end
  ...
  test "should update stop" do
    put :update, id: @stop, stop: { line_id: @stop.line_id, times: @stop.times, title: @stop.title, x: @stop.x, y: @stop.y }
    assert_redirected_to stop_path(assigns(:stop))
  end
