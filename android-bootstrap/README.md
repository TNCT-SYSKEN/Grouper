...
[![Build Status](https://travis-ci.org/AndroidBootstrap/org-sysken-grouper.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/org-sysken-grouper)

This repository contains the source code for the [Grouper](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=org.sysken.grouper).

Please see the [issues](https://github.org.sysken.grouper/org-sysken-grouper/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Grouper? Ask away on the [org-sysken-grouper discussion forum](https://groups.google.com/forum/#!forum/org-sysken-grouper).

<a href="https://play.google.com/store/apps/details?id=org.sysken.grouper" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __org.sysken.grouper__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____org.sysken.grouper__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.org.sysken.grouper.R__) will now be renamed
...
signed with a different key.  Manually uninstall Grouper from your device and
...
Grouper is a result of a template project I've developed over the years as well as
...
Grouper is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.org.sysken.grouper/org-sysken-grouper/contributors) on
...
[pull requests](https://github.org.sysken.grouper/org-sysken-grouper/pulls).
