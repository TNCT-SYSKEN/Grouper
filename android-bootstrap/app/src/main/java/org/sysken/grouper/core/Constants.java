...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "org.sysken.grouper";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Grouper";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "org.sysken.grouper.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "org.sysken.grouper.";
